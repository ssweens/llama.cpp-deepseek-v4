...
- **Fix direction:** Update the IQ2 quantization recipe to keep indexer + compressor tensors at higher precision. Reasonable targets: BF16 for the smallest ones (already true for `indexer.proj` in this GGUF), Q5_K/Q6_K for the larger compressor matrices.
