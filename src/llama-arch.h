...
enum llm_kv {
    ...
    LLM_KV_ACTIVATION_SPARSITY_SCALE,
    LLM_KV_SWIGLU_LIMIT,
    LLM_KV_HYPERCONNECTION_MULT,
    LLM_KV_HYPERCONNECTION_SINKHORN_ITERS,
    LLM_KV_HYPERCONNECTION_EPS,
    ...
    LLM_KV_ATTENTION_INDEX_HEAD_COUNT,
    LLM_KV_ATTENTION_INDEX_HEAD_DIM,
    LLM_KV_ATTENTION_INDEX_TOPK,
    LLM_KV_ATTENTION_COMPRESS_RATIOS,
    LLM_KV_ATTENTION_COMPRESS_ROPE_THETA,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ATTN_INDEXER_Q_B,
    LLM_TENSOR_ATTN_INDEXER_WEIGHTS_PROJ,
    LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WKV,
    LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WGATE,
    LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_APE,
    LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_NORM,
