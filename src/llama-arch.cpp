...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_NUM_HASH_LAYERS,                   "%s.hash_layer_count"                  },
    ...
    { LLM_KV_HYPERCONNECTION_MULT,              "%s.hyper_connection.count"            },
    { LLM_KV_HYPERCONNECTION_SINKHORN_ITERS,    "%s.hyper_connection.sinkhorn_iterations" },
    { LLM_KV_HYPERCONNECTION_EPS,               "%s.hyper_connection.epsilon"          },
    ...
    { LLM_KV_ATTENTION_INDEX_HEAD_COUNT,             "%s.attention.indexer.head_count"            },
    { LLM_KV_ATTENTION_INDEX_HEAD_DIM,               "%s.attention.indexer.key_length"            },
    { LLM_KV_ATTENTION_INDEX_TOPK,                   "%s.attention.indexer.top_k"                  },
    { LLM_KV_ATTENTION_COMPRESS_RATIOS,              "%s.attention.compress_ratios"               },
    { LLM_KV_ATTENTION_COMPRESS_ROPE_THETA,          "%s.attention.compress_rope_freq_base"       },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_WKV,                               "blk.%d.attn_kv" },
    { LLM_TENSOR_ATTN_O_A,                               "blk.%d.attn_output_a" },
    { LLM_TENSOR_ATTN_O_B,                               "blk.%d.attn_output_b" },
    ...
    { LLM_TENSOR_ATTN_INDEXER_Q_B,                       "blk.%d.indexer.attn_q_b" },
    { LLM_TENSOR_ATTN_INDEXER_WEIGHTS_PROJ,              "blk.%d.indexer.proj" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WKV,            "blk.%d.indexer_compressor_kv" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WGATE,          "blk.%d.indexer_compressor_gate" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_APE,            "blk.%d.indexer_compressor_ape" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_NORM,           "blk.%d.indexer_compressor_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_HC_HEAD_FN,                 {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_HC_HEAD_BASE,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_ADD}},
    {LLM_TENSOR_HC_HEAD_SCALE,              {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
