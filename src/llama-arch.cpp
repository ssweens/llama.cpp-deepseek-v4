...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ACTIVATION_SPARSITY_SCALE,         "%s.activation_sparsity_scale"         },
    { LLM_KV_SWIGLU_LIMIT,                      "%s.swiglu_limit"                      },
    { LLM_KV_HYPERCONNECTION_MULT,              "%s.hyperconnection.mult"              },
    { LLM_KV_HYPERCONNECTION_SINKHORN_ITERS,    "%s.hyperconnection.sinkhorn_iters"    },
    { LLM_KV_HYPERCONNECTION_EPS,               "%s.hyperconnection.eps"               },
    ...
    { LLM_KV_ATTENTION_OUTPUT_LORA_RANK,             "%s.attention.o_lora_rank"                  },
    { LLM_KV_ATTENTION_OUTPUT_GROUP_COUNT,           "%s.attention.output_group_count"            },
    { LLM_KV_ATTENTION_INDEX_HEAD_COUNT,             "%s.attention.index_head_count"              },
    { LLM_KV_ATTENTION_INDEX_HEAD_DIM,               "%s.attention.index_head_dim"                },
    { LLM_KV_ATTENTION_INDEX_TOPK,                   "%s.attention.index_topk"                    },
    { LLM_KV_ATTENTION_COMPRESS_RATIOS,              "%s.attention.compress_ratios"               },
    { LLM_KV_ATTENTION_COMPRESS_ROPE_THETA,          "%s.attention.compress_rope_theta"           },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_WKV,                               "blk.%d.attn_wkv" },
    { LLM_TENSOR_ATTN_O_A,                               "blk.%d.attn_o_a" },
    { LLM_TENSOR_ATTN_O_B,                               "blk.%d.attn_o_b" },
    { LLM_TENSOR_ATTN_COMPRESSOR_WKV,                    "blk.%d.attn_compressor_wkv" },
    { LLM_TENSOR_ATTN_COMPRESSOR_WGATE,                  "blk.%d.attn_compressor_wgate" },
    { LLM_TENSOR_ATTN_COMPRESSOR_APE,                    "blk.%d.attn_compressor_ape" },
    { LLM_TENSOR_ATTN_COMPRESSOR_NORM,                   "blk.%d.attn_compressor_norm" },
    { LLM_TENSOR_ATTN_INDEXER_Q_B,                       "blk.%d.attn_indexer_q_b" },
    { LLM_TENSOR_ATTN_INDEXER_WEIGHTS_PROJ,              "blk.%d.attn_indexer_weights_proj" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WKV,            "blk.%d.attn_indexer_compressor_wkv" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WGATE,          "blk.%d.attn_indexer_compressor_wgate" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_APE,            "blk.%d.attn_indexer_compressor_ape" },
    { LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_NORM,           "blk.%d.attn_indexer_compressor_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_WKV,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_COMPRESSOR_APE,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_COMPRESSOR_NORM,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_INDEXER_Q_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_INDEXER_WEIGHTS_PROJ,  {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WKV,{LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_WGATE,{LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_APE,{LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_INDEXER_COMPRESSOR_NORM,{LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_HC_HEAD_FN,                 {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_HC_HEAD_BASE,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_HC_HEAD_SCALE,              {LLM_TENSOR_LAYER_INPUT,     GGML_OP_NONE}},
    {LLM_TENSOR_HC_ATTN_FN,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_HC_ATTN_BASE,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_HC_ATTN_SCALE,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_HC_FFN_FN,                  {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_HC_FFN_BASE,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_HC_FFN_SCALE,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
    {LLM_TENSOR_FFN_GATE_TID2EID,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_NONE}},
